      ...
      <div className="container">
        <div className="row g-4">
          ...
          <div className="col-lg-4 col-md-6">
            ...
            <div className="d-flex gap-3 mt-3">
              <a href="https://twitter.com/viaboreal" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="https://discord.gg/vitruveo" target="_blank" rel="noopener noreferrer" aria-label="Discord">
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <ul className="list-unstyled small">
              ...
              <li className="mb-2"><span className="text-muted-light">Chain ID: 1490</span></li>
            </ul>
          </div>
        </div>
        ...
        <div className="row mt-5 pt-4 border-top border-secondary">
          ...
          <div className="col-md-6 text-md-end">
            <p className="text-muted-light small mb-0">
              5s blocks • 4 gwei • EVM Compatible
            </p>
          </div>
        </div>
      </div>
